<?php
/**
 * Template Name: Format Gallery: Image
 * Description: A Page Template that displays all Image post formats in a gallery view.
 *
 * @package WordPress
 * @subpackage Hoon
 * @since 1.0
...
<div class="row">
	...
	<section id="content" class="<?php echo esc_attr( hoon_main_column_width() . ' image-gallery gallery-blocks' ); ?>">
